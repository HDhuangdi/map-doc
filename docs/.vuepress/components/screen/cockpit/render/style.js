export default {
  ...
  sources: {
    composite: {
      ...
      maxzoom: 14,
      minzoom: 0,
      tiles: ['https://hzwateritzx.com/tile/{z}/{x}/{y}.pbf'],
    },
  },
  sprite: 'https://hzwateritzx.com/static/sprite/sprite',
  glyphs: 'https://nssa.dbappsecurity.com.cn:40012/fonts/{fontstack}/{range}.pbf',
  light: {
    anchor: 'map',
    color: '#fff',
    intensity: 0.3,
