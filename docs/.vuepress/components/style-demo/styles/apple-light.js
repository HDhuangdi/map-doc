...
export default {
    ...
    layers: [
        // 底色、海洋色
        {
            ...
            paint: { "background-color": "rgb(140, 220, 247)" },
        },
        // 陆地
        {
            id: "land",
            ...
            filter: ["all"],
            layout: { visibility: "visible" },
            paint: { "fill-color": "rgb(242, 241, 234)" },
        },
        // 水域
        {
            id: "water",
            ...
            filter: ["all"],
            layout: { visibility: "visible" },
            paint: { "fill-color": "rgb(140, 220, 247)" },
        },
        {
            id: "grass",
            type: "fill",
        ...
        },
        {
            ...
            paint: {
                ...
                "line-color": "rgb(176, 186, 207)",
                "line-opacity": 1,
            },
        },
        // 都市快速路
        {
            id: "highway_major_trunk_outer",
            type: "line",
            source: "composite",
            "source-layer": "roads",
            minzoom: 6,
